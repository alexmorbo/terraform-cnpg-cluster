...
| <a name="input_poolers"></a> [poolers](#input\_poolers) | PgBouncer connection poolers (CNPG 0.5.0+) | <pre>list(object({<br/>    name      = string<br/>    type      = optional(string, "rw")<br/>    instances = optional(number, 3)<br/>    poolMode  = optional(string, "transaction")<br/>    parameters = optional(map(string), {<br/>      max_client_conn   = "1000"<br/>      default_pool_size = "25"<br/>    })<br/>    monitoring = optional(object({<br/>      enabled = optional(bool, false)<br/>    }))<br/>    template = optional(object({<br/>      spec = optional(object({<br/>        containers = optional(list(object({<br/>          name = string<br/>          resources = optional(object({<br/>            requests = optional(map(string), {})<br/>            limits   = optional(map(string), {})<br/>          }))<br/>        })))<br/>        nodeSelector = optional(map(string))<br/>        tolerations = optional(list(object({<br/>          key      = optional(string)<br/>          operator = optional(string, "Equal")<br/>          value    = optional(string)<br/>          effect   = optional(string)<br/>        })))<br/>      }))<br/>    }))<br/>  }))</pre> | `[]` | no |
